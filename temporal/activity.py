...
current_activity_context: ContextVar["ActivityContext"] = contextvars.ContextVar(
...
class ActivityTask:
    @classmethod
    def from_poll_for_activity_task_response(
        cls, task: PollActivityTaskQueueResponse
    ) -> "ActivityTask":
